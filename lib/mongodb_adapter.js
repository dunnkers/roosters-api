...
/*exports.setScheduleRelations = function (collection) {
	return exports.findAll(collection).then(function (docs) {
		return exports.resolveScheduleRelations(collection, docs).then(function (docs) {
...
exports.resolveScheduleRelations = function (collection, docs, callback) {
	return RSVP.all(docs.map(function (doc) {
		return exports.resolveScheduleRelation(collection, doc, callback);
	}));
};

exports.resolveScheduleRelation = function (collection, doc, callback) {
